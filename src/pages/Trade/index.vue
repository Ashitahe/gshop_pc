  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="address clearFix">
        <span class="username selected">{{ consignee }}</span>
        <p>
          <span class="s1">{{ deliveryAddress }}</span>
          <span class="s2">{{ consigneeTel }}</span>
...
export default {
  ...
  methods: {
    submitOrder() {
      ...
      this.$API
        .postOrder(this.tradeNo, tradeInfo)
        .then((result) => {
          if (result.code === 200) {
            console.log(result);
